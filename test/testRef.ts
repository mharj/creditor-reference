...
describe('ref numbers', () => {
	...
	describe('build()', () => {
		it('should build ref codes', () => {
			...
			expect(build('539007547034', RefType.ISO, {leadingZeroes: true})).to.be.eq('RF18000000000539007547034').and.length(25); // header + 21
			expect(build('8', RefType.FI, {leadingZeroes: true})).to.be.eq('00000000000000000084').and.length(20);  // 19 + check
		});
